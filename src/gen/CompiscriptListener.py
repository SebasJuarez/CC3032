...
class CompiscriptListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CompiscriptParser#typeSpec.
    def enterTypeSpec(self, ctx:CompiscriptParser.TypeSpecContext):
        pass

    # Exit a parse tree produced by CompiscriptParser#typeSpec.
    def exitTypeSpec(self, ctx:CompiscriptParser.TypeSpecContext):
        pass
